...
public class MyListAdapterTwo extends ArrayAdapter<ModuleCustomClass>{

    private Context mContext;

    public MyListAdapterTwo(Context context, ArrayList<ModuleCustomClass> moduleCustomClass){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if(convertView==null){
            convertView= LayoutInflater.from(getContext()).inflate(R.layout.list_view_two,parent,false);
        }
